...
const ShelterAdoptions = () => {
    ...
    const { sToken, adoptions, getAdoptions, cancelAdoption, completeAdoption } = useContext(ShelterContext)
    ...
    return (
        <div className='w-full max-w-6xl m-5'>
            ...
            <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll'>
                ...
                {adoptions.reverse().map((item, index) => (
                    <div className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50' key={index}>
                        ...
                        {item.cancelled
                            ...
                            : <div className='flex'>
                                ...
                                <img onClick={() => completeAdoption(item._id)} className='w-10 cursor-pointer' src={assets.tick_icon} alt="" />
                            </div>}
                    </div>
                ))}
            </div>
